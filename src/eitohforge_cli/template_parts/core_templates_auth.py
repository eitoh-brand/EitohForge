...
class SsoLinkStore(Protocol):
    def resolve_subject(self, *, provider: str, external_subject: str, tenant_id: str | None) -> str | None:
        ...

    def upsert_link(
        self, *, provider: str, external_subject: str, tenant_id: str | None, internal_subject: str
    ) -> None:
        ...
