"""External API infrastructure template fragments."""

EXTERNAL_API_FILE_TEMPLATES: dict[str, str] = {
    "app/infrastructure/external_api/__init__.py": """from app.infrastructure.external_api.client import ResilientExternalApiClient
from app.infrastructure.external_api.contracts import (
    ApiCallResult,
    ApiRequest,
    ApiResponse,
...
""",
    "app/infrastructure/external_api/contracts.py": """from __future__ import annotations
...
class ExternalApiTransport(Protocol):
    def send(self, request: ApiRequest) -> Awaitable[ApiResponse] | ApiResponse:
        ...
""",
    "app/infrastructure/external_api/client.py": """import asyncio
